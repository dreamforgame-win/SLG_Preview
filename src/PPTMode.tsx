...
import { X, Plus, Trash2, Edit2, Save, Minus } from 'lucide-react';
  ...
  return (
    <>
      <button
        ...
        className="bg-[#222] text-[#00d2ff] border border-[#00d2ff] px-4 py-2 rounded shadow-lg hover:bg-[#333] font-bold cursor-pointer flex items-center gap-2"
      >
        <span>PPT专用</span>
      </button>

      {isOpen && (
        <div className="fixed top-0 left-0 h-screen w-1/4 min-w-[300px] bg-[#1a1a1a] border-r border-[#333] z-[100] flex flex-col shadow-2xl text-white">
